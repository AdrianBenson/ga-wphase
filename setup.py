...
wphase_files = get_package_data("wphase", "ATWS", [])
...
FORTRAN_BPFILTER = os.path.join(
    os.path.abspath(os.path.dirname(__file__)), "wphase", "psi", "bpfilter.f"
)
...
setup(
    ...
    package_data={"wphase": wphase_files, "wphase.psi": ["tables/*.*"]},
