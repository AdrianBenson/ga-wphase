...
def load_metadata(
    ...
    dist_range,
    networks,
    t_before_origin=3600.0,
    t_after_origin=3600.0,
):
            ...
            try:
                ...
                for sta in stas[0]:
                    try:
                        ...
                        # ... by channel
                        chans = caller_maker(
                            network=net.code, station=sta.code, level="channel"
                        )()
...
def runwphase(
    ...
    **kwargs,
    ...
    if streams is None:
        ...
        server, metadata, failures = load_metadata(server, eqinfo, dist_range, networks)
    ...
    try:
        ...
        wphase_output[settings.WPHASE_ERROR_STACKTRACE_KEY] = "".join(
